...
<template>
  <div class="container">
    <div
      class="panel weatherPanel"
      onmousedown="FocusWindow('weather')"
      style="display: none"
      id="weatherPanel"
    >
      ...
      <div class="header noselect">
        <div class="headerIcons">
          <i
            class="ms-Icon ms-Icon--ChromeMinimize"
            id="welcomeMinimize"
            aria-hidden="true"
            onClick="MinimizeWindow('weather')"
          ></i>
          <i
            class="ms-Icon ms-Icon--ChromeClose"
            id="welcomeClose"
            aria-hidden="true"
            onClick="CloseWindow('weather')"
          ></i>
        </div>
      </div>
    ...
    <div class="panel startMenuPanel noselect" style="display: none" id="startMenuPanel">
      <div class="startMenuContainer">
        ...
        <div class="allAppsButton">
          <small style="opacity: 0.8">All apps ></small>
        </div>
      </div>
      <div class="iconRow">
        <div class="startMenuIcon">
          <svg
            class="startMenuIcon-Inner"
          ...
          <div class="startMenuIconText">Edge</div>
        </div>
        <div class="startMenuIcon">
          <img
          ...
          />
          <div class="startMenuIconText">Word</div>
        </div>
        <div class="startMenuIcon">
          <img
            ...
            alt="Word product icon"
          />
          <div class="startMenuIconText">Excel</div>
        </div>
        <div class="startMenuIcon">
          <img
            ...
            alt="Word product icon"
          />
          <div class="startMenuIconText">PowerPoint</div>
        </div>
        <div class="startMenuIcon">
          <img
            src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/outlook_48x1.svg"
            width="35"
            height="35"
            class="taskbarItem"
            alt="Word product icon"
          />
          <div class="startMenuIconText">Outlook</div>
        </div>
        <div class="startMenuIcon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="startMenuIconText">Calendar</div>
        </div>
      </div>
      <div class="iconRow mt50">
        <div class="startMenuIcon">
          ...
          >
            ...
            <path
              fill="url(#2Jwv7LuZrao5GsFL~0k11a)"
            ...
            <path
              fill="url(#2Jwv7LuZrao5GsFL~0k11b)"
          ...
          <div class="startMenuIconText">Xbox</div>
        </div>
        <div class="startMenuIcon">
          <svg
            fill="#000000"
          ...
          <div class="startMenuIconText">CodePen</div>
        </div>
        <div class="startMenuIcon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <path
              fill="#b71c1c"
              d="M31,12h-5v23.5c2.5,0,4.986,0.512,5,0.5S31,12,31,12z"
            />
            <path
              fill="#b71c1c"
              d="M17,12h5v23.5c-2.5,0-4.986,0.512-5,0.5S17,12,17,12z"
            />
            <path
              fill="#e53935"
              d="M22,12h-5l9,23.5c2.5,0,4.986,0.512,5,0.5S22,12,22,12z"
            />
          </svg>
          <div class="startMenuIconText">Netflix</div>
        </div>
        <div class="startMenuIcon">
          <img
            ...
            alt="Word product icon"
          />
          <div class="startMenuIconText">Teams</div>
        </div>
        <div class="startMenuIcon">
          <img
            src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/access_48x1.svg"
            width="35"
            height="35"
            class="taskbarItem"
            alt="Word product icon"
          />
          <div class="startMenuIconText">Access</div>
        </div>
        <div class="startMenuIcon">
          <img
            src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/office_48x1.svg"
            width="35"
            height="35"
            class="taskbarItem"
            alt="Word product icon"
          />
          <div class="startMenuIconText">Office</div>
        </div>
      </div>
      <div class="iconRow mt50">
        <div class="startMenuIcon">
          <img
            ...
            alt="Word product icon"
          />
          <div class="startMenuIconText">OneDrive</div>
        </div>
        <div class="startMenuIcon">
          <img
            src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/onenote_48x1.svg"
            width="35"
            height="35"
            class="taskbarItem"
            alt="Word product icon"
          />
          <div class="startMenuIconText">OneNote</div>
        </div>
        <div class="startMenuIcon">
          <img
            src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/project_48x1.svg"
            width="35"
            height="35"
            class="taskbarItem"
            alt="Word product icon"
          />
          <div class="startMenuIconText">Project</div>
        </div>
        <div class="startMenuIcon">
          <img
            ...
            alt="Word product icon"
          />
          <div class="startMenuIconText">SharePoint</div>
        </div>
        <div class="startMenuIcon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="startMenuIconText">Spotify</div>
        </div>
        <div class="startMenuIcon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="startMenuIconText">Photoshop</div>
        </div>
      </div>
      <div class="startMenuContainer mt50">
        Recommended
        <div class="moreButton">
          <small style="opacity: 0.8">More ></small>
        </div>
      </div>
      <div class="iconRow">
        <div class="startMenuRecommended">
          ...
          <div class="startMenuRecommended-Text ml10">
            Adobe Photoshop <br />
            <span class="lightText">Recently added</span>
          </div>
        </div>
        <div class="startMenuRecommended">
          ...
          <div class="startMenuRecommended-Text">
            2021 Monthly Expenses <br />
            <span class="lightText">17m ago</span>
          </div>
        </div>
      </div>
      ...
      <div class="iconRow mt20">
        <div class="startMenuRecommended">
          ...
          <div class="startMenuRecommended-Text ml10">
            Windows 11 Fluent Design <br />
            <span class="lightText">2h ago</span>
          </div>
        </div>
        <div class="startMenuRecommended">
          <div class="startMenuRecommended-Icon">
          ...
          <div class="startMenuRecommended-Text">
            ...
            <span class="lightText">12h ago</span>
          </div>
        </div>
      </div>
      <div class="shutdownRow">
        <div class="profilePicture"></div>
        <div class="profileName">Josh Salazar</div>
        <div class="powerButton">
          <i class="ms-Icon ms-Icon--PowerButton" aria-hidden="true"></i>
                                                      ...
                                                      <div class="panel note-panel" v-if="close" id="welcomenote" onmousedown="FocusWindow('welcome')">
      <div class="header noselect">
        <span class="lightText"
          ><i
            class="ms-Icon ms-Icon--QuickNoteSolid headerTitleIcon"
            aria-hidden="true"
          ></i
          ><span class="headerTitleText"> Welcome</span>
        ...
        <div class="headerIcons">
          <i
            ...
            id="welcomeMinimize"
            aria-hidden="true"
            onClick="MinimizeWindow('welcome')"
          ></i>
          <i class="ms-Icon ms-Icon--ChromeRestore" aria-hidden="true">
      <v-icon @click="close = false" style="text-align: end;margin:auto" > mdi-close</v-icon>
      ...
      <div class="panel-body" id="panelBody">
              ...
              <g id="surface1">
                <path
                  style="
                    ...
                    fill-opacity: 1;
                  "
                  d="M 227.570313 307.621094 L 227.570313 387.675781 L 387.675781 387.675781 L 387.675781 227.570313 L 227.570313 227.570313 Z M 56.03125 307.621094 L 56.03125 387.675781 L 216.132813 387.675781 L 216.132813 227.570313 L 56.03125 227.570313 Z M 227.570313 136.082031 L 227.570313 216.132813 L 387.675781 216.132813 L 387.675781 56.03125 L 227.570313 56.03125 Z M 56.03125 136.082031 L 56.03125 216.132813 L 216.132813 216.132813 L 216.132813 56.03125 L 56.03125 56.03125 Z M 56.03125 136.082031 "
                />
              </g>
            </svg>
            &nbsp;Windows 11
        ...
        <div class="noteBodyText">
          <p>
            Welcome to my build of the Windows 11 UI. I tried my best to recreate the
            Windows 11 UI based on the Fluent Design documentation and the recently
            released Windows 11 preview video. At the time of making this, that's all I
            had to go off. I'm curious to see how far I missed the mark once Windows 11 is
            publicly available. Have fun and play around!
          </p>
          <p>Here are some things you can explore:</p>
          <ul>
            <li>Check the weather by clicking the cloud in the taskbar</li>
            <li>Open the Windows start menu</li>
            <li>
              Drag windows around, close them, minimize them. Window states will update,
              z-indexes will update, windows will animate in and out depending on if
              you're restoring the window, closing the window, or minimizing the window.
            </li>
            <li>COMING SOON: Shut the computer down in the start menu</li>
            <li>
              COMING SOON: Open the settings from the taskbar and switch to a dark theme
            </li>
            <li>
              TO DO: Polish! It could use some buffing around the edges to get it more
              in-line with Fluent Design.
            </li>
            <li>
              TO DO: Clean-up code. It's a mess. I'll need to do this before I get dark /
              light mode working.
            </li>
          </ul>
        </div>
    ...
    <div  class="panel note-panel" v-if="done" id="welcomenote" onmousedown="FocusWindow('welcome')">
      <div class="header noselect">
        <span class="lightText"
          ><i
            class="ms-Icon ms-Icon--QuickNoteSolid headerTitleIcon"
        ...
        <div class="headerIcons">
          ...
          ></i>
          <i class="ms-Icon ms-Icon--ChromeRestore" aria-hidden="true">
      <v-icon @click="done = false" style="text-align: end;margin:auto" > mdi-close</v-icon>
      ...
      />
      <div
        class="taskbarIconIndicator"
        style="display: none"
        id="startMenuTaskbarIndicator"
      ></div>
    </div>
            &nbsp;Word
          </div>
...
<div  class="panel note-panel" v-if="PowerPoint" id="welcomenote" onmousedown="FocusWindow('welcome')">
      <div class="header noselect">
        <span class="lightText"
          ><i
            class="ms-Icon ms-Icon--QuickNoteSolid headerTitleIcon"
        ...
        <div class="headerIcons">
          ...
          ></i>
          <i class="ms-Icon ms-Icon--ChromeRestore" aria-hidden="true">
      <v-icon @click="PowerPoint = false" style="text-align: end;margin:auto" > mdi-close</v-icon>
...
<div  class="panel note-panel" v-if="PowerPoint" id="welcomenote" onmousedown="FocusWindow('welcome')">
  ...
  <v-row>
    ...
    >
      <div class="header noselect">
        <span class="lightText"
          ><i class="ms-Icon ms-Icon--Settings headerTitleIcon" aria-hidden="true"></i
          ><span class="headerTitleText"> Settings</span></span
        >
        <div class="headerIcons">
          <i
            class="ms-Icon ms-Icon--ChromeMinimize"
      ...
      <div class="panel-body settingsPanelBody noselect" id="panelBody">
        <div class="settingsProfileRow">
          <div class="profilePicture-settings"></div>
          <div class="settingsName">
            Josh Salazar <br />
            <small class="lightText">joshua.a.salazar@gmail.com</small>
          </div>
        </div>
        ...
        <div class="settingsRightColumn">
          ...
          <div class="themeSelect">
            ...
            <div class="lightThemePick active"></div>
            <div class="darkThemePick"></div>
          </div>
          <div class="settingsOptions">
            <div class="settingsSystemOption">
              <i
                class="ms-Icon ms-Icon--PhotoCollection systemIcon"
                aria-hidden="true"
              ></i>
  ...
  <div class="taskbar noselect">
    <div
    @click="close = true"
      class="taskbarIconWrapper"
      id="startmenuTaskbarIcon"
      onClick="TaskbarIconClick('startMenu')"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g id="surface1">
          <path
            style="
              stroke: none;
              fill-rule: nonzero;
              fill: rgb(0%, 47.099304%, 83.099365%);
              fill-opacity: 1;
            "
            d="M 227.570313 307.621094 L 227.570313 387.675781 L 387.675781 387.675781 L 387.675781 227.570313 L 227.570313 227.570313 Z M 56.03125 307.621094 L 56.03125 387.675781 L 216.132813 387.675781 L 216.132813 227.570313 L 56.03125 227.570313 Z M 227.570313 136.082031 L 227.570313 216.132813 L 387.675781 216.132813 L 387.675781 56.03125 L 227.570313 56.03125 Z M 56.03125 136.082031 L 56.03125 216.132813 L 216.132813 216.132813 L 216.132813 56.03125 L 56.03125 56.03125 Z M 56.03125 136.082031 "
          />
    ...
    <div
      class="taskbarIconWrapper"
      id="settingsTaskbarIcon"
      onClick="TaskbarIconClick('settings')"
    >
      <i
        class="ms-Icon ms-Icon--Settings taskbarIcon taskbarItem"
        style="font-size: 1.8rem; position: relative; top: 3px"
        aria-hidden="true"
      ></i>
      <div
        class="taskbarIconIndicator"
        style="display: none"
        id="settingsTaskbarIndicator"
      ></div>
    </div>
    <div @click="done = true" class="taskbarIconWrapper">
      <img
        src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/word_48x1.svg"
        width="35"
        height="35"
    ...
    <div @click="PowerPoint = true" class="taskbarIconWrapper">
      <img
        src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/powerpoint_48x1.svg"
        width="35"
        height="35"
    ...
    <div @click="Excl" class="taskbarIconWrapper">
      <img
        src="https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/svg/excel_48x1.svg"
        width="35"
        height="35"
...
.profilePicture {
  background-image: url("https://media-exp1.licdn.com/dms/image/C4E03AQFRViiHuMISHw/profile-displayphoto-shrink_100_100/0/1560275616234?e=1634169600&v=beta&t=WMfRRfR1ifCsWxHJtYN4Eow7j8B9fOLQ2rlBzIzbJsM");
  width: 40px;
  height: 40px;
  border-radius: 50%;
